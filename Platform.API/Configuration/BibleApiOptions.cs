...
/// Bind to the <c>BibleApi</c> configuration section or supply values directly.
/// </summary>
public sealed class BibleApiOptions
{
    /// <summary>
    /// The configuration section name to bind from <c>appsettings.json</c> or environment variables.
    /// </summary>
    public const string SectionName = "BibleApi";

    /// <summary>
    /// Your Platform app key. Sent as the <c>X-YVP-App-Key</c> header
